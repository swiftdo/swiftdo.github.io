...
学习笔记之余，可用我们的产品 [易起卦](/yiqigua.html) 做六爻练习：

- App / 小程序：六爻排盘、一键起卦；App 不解卦，提供 AI 提示词模板方便提问；另有卦签诗与卦例、六爻学习、历史记录（数据本地存储）
- 也可延伸服务：六爻起卦、八字分析、风水咨询、择日、取名等

👉 [打开易起卦产品页](/yiqigua.html)
