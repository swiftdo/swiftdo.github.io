...
欢迎光临“小程序搜索”，请您仔细阅读以下条款，如果您对本协议的任何条款表示异议，您可以选择不使用“小程序搜索”；进入“小程序搜索”则意味着您将同意遵守本协议下全部规定，并完全服从于app开发者的统一管理。

## 第一章 总则

第1条 “小程序搜索”是app开发者向用户提供的信息存储空间，为用户提供讨论、交流的平台。

第2条 “小程序搜索”所有权、经营权、管理权均属app开发者。
...
第7条 用户的言行不得违反《计算机信息网络国际联网安全保护管理办法》、《互联网信息服务管理办法》、《互联网电子公告服务管理规定》、《维护互联网安全的决定》、《互联网新闻信息服务管理规定》等相关法律规定，不得在“小程序搜索”发布、传播或以其它方式传送含有下列内容之一的信息：
...
第10条 app开发者拥有对违反“小程序搜索”规则的用户进行处理的权力，直至禁止其在“小程序搜索”内发布信息。
